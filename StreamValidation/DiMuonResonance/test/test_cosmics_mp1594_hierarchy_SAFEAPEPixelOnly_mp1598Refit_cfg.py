...
options.register('OutFileName',
                 "testingRefit_mp1594_hierarchy_SAFEAPEPixelOnly_mp1598Refit_NTUPLE.root", # default value
...
process.conditionsInTrackerAlignmentRcd = CalibTracker.Configuration.Common.PoolDBESSource_cfi.poolDBESSource.clone(
     connect = cms.string('sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/MP/MPproduction/mp1598/jobData/jobm1/alignments_MP.db'),
