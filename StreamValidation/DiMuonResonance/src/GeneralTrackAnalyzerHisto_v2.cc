...
class GeneralTrackAnalyzerHisto_v2 : public edm::EDAnalyzer {
 public:
  GeneralTrackAnalyzerHisto_v2(const edm::ParameterSet& pset) {
...
DEFINE_FWK_MODULE(GeneralTrackAnalyzerHisto_v2);
